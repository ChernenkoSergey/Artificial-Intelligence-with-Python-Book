# if the code doesn't work, then
# 1 delete line 'import cvxopt'
# 2 in CMD 'pip uninstall numpy' 
# 3 download numpy + mkl wheel your version
# 4 in CMD 'pip install numpy + mkl .whl' your version
